          ...
          >
            {scrollingTestimonials.map((testimonial, index) => (
              <div 
                ...
                className="inline-block px-4 w-[1500px] sm:w-[1500px]"
              >
                <motion.div
                  className="bg-white p-8 rounded-3xl shadow-lg h-full border border-pink-100 inline-block whitespace-normal"
                  whileHover={{ scale: 1.02 }}
                >
                  {/* Profile image */}
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 rounded-full overflow-hidden border-4 border-pink-200 shadow-md">
